<template>
	<div class="departure">
		...
		<div class="departure__next">
			{{ departure.departure.wait.minutes <= 0 ? now : departure.departure.wait.minutes }}
		</div>
		<div
			class="departure__thereafter"
			v-if="thereafter"
		>
			{{ (thereafter.departure.wait.minutes <= 0) ? now : thereafter.departure.wait.minutes }}
		</div>
		<div class="departure__thereafter departure__thereafter--none" v-else />
	</div>
</template>

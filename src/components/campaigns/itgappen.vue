				...
				<div class="app-badge">
					<a href="https://itggot.info/itgappen-ios" class="app-badge">
						<img
							...
							src="/img/campaigns/sv-appstore-badge.svg"
							class="app-badge__logo app-badge__logo--app-store"
							draggable="false"
						/>
						<span class="app-badge__link">
				...
				<div class="app-badge">
					<a href="https://itggot.info/itgappen-android" class="app-badge">
						<img
							...
							src="/img/campaigns/sv-google-play-badge.png"
							class="app-badge__logo app-badge__logo--google-play"
							draggable="false"
						/>
						<span class="app-badge__link">
...
.app-badges {
	...
	.app-badge {
		...
		&__logo--google-play, &__logo--app-store {
			max-height: 40px;
			flex: 1 0 50%;
		}
	}
